...
def backup_database() -> None:
    ...
    try:
        ...
        with open(filepath, 'w') as f:
            result = subprocess.run(cmd, stdout=f, stderr=subprocess.PIPE, text=True, env=_build_env(), check=False)
...
def restore_database() -> None:
    ...
    try:
        ...
        with open(filepath) as f:
            result = subprocess.run(cmd, stdin=f, stderr=subprocess.PIPE, text=True, env=_build_env(), check=False)
